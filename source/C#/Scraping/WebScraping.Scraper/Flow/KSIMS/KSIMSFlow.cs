...
namespace WebScraping.Scraper.Flow.KSIMS
{
    class KSIMSFlow : AbstractScrapFlow
    {
        //this is not web platform
        public KSIMSFlow(ScrapBrowser browser, Parameter param)
            : base(browser, param)
        {
            logger.Info("KSIMSFlow initialize");
        }
