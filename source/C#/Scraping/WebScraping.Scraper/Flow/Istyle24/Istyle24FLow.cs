...
namespace WebScraping.Scraper.Flow.Istyle24
{
    class Istyle24Flow : AbstractScrapFlow
    {
        public Istyle24Flow(ScrapBrowser browser, Parameter param)
            : base(browser, param)
        {
            logger.Info("Istyle24Flow initialize");
        }
        ...
        {
            return "http://seller-scm.istyle24.com/Login.aspx";
        }
