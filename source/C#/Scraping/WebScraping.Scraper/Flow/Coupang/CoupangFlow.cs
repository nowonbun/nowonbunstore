...
namespace WebScraping.Scraper.Flow.Coupang
{
    class CoupangFlow : AbstractScrapFlow
    {
        public CoupangFlow(ScrapBrowser browser, Parameter param)
            : base(browser, param)
        {
            logger.Info("CoupangFlow initialize");
        }
        ...
        {
            return "https://wing.coupang.com/login";
        }
