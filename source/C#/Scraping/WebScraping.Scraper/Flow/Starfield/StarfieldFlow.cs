...
namespace WebScraping.Scraper.Flow.Starfield
{
    class StarfieldFlow : AbstractScrapFlow
    {
        public StarfieldFlow(ScrapBrowser browser, Parameter param)
            : base(browser, param)
        {
            logger.Info("StarfieldFlow initialize");
        }
        ...
        {
            return "https://tenant.starfield.co.kr/com/websrc/indexStarfieldT.html";
        }
