...
namespace WebScraping.Scraper.Flow.Lotteimall
{
    class LotteimallFlow : AbstractScrapFlow
    {
        public LotteimallFlow(ScrapBrowser browser, Parameter param)
            : base(browser, param)
        {
            logger.Info("LotteimallFlow initialize");
        }
        ...
        {
            return "https://partner.lotteimall.com/main/Login.lotte";
        }
