...
namespace WebScraping.Scraper.Flow.Akmall
{
    class AkmallFlow : AbstractScrapFlow
    {
        public AkmallFlow(ScrapBrowser browser, Parameter param)
            : base(browser, param)
        {
            logger.Info("AkmallFlow initialize");
        }
        ...
        {
            return "https://splace.akmall.com/wqxml/loginSplace.html";
        }
