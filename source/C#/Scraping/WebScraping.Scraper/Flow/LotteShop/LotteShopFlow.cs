...
namespace WebScraping.Scraper.Flow.LotteShop
{
    class LotteShopFlow : AbstractScrapFlow
    {
        public LotteShopFlow(ScrapBrowser browser, Parameter param)
            : base(browser, param)
        {
            logger.Info("LotteShopFlow initialize");
        }
        ...
        {
            return "http://together.lotteshopping.com/EMDV3/index.html";
        }
