...
namespace WebScraping.Scraper.Flow.Cardsales
{
    class CardsalesFlow : AbstractScrapFlow
    {
        public CardsalesFlow(ScrapBrowser browser, Parameter param)
            : base(browser, param)
        {
            logger.Info("CardsalesFlow initialize");
        }
        ...
        {
            return "https://www.cardsales.or.kr/signin";
        }
