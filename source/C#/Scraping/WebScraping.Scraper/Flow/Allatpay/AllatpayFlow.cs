...
namespace WebScraping.Scraper.Flow.Allatpay
{
    class AllatpayFlow : AbstractScrapFlow
    {
        public AllatpayFlow(ScrapBrowser browser, Parameter param)
            : base(browser, param)
        {
        ...
        {
            return "http://www.allatpay.com/servlet/AllatBizV2/login/LoginCL";
        }
