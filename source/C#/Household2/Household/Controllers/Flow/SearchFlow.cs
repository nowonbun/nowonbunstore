...
namespace Household.Controllers
{
    public class SearchFlow : AbstractFlow
    {
        ...
        public override ActionResult Run()
        {
            ...
            Decimal accountSum = Decimal.Parse(HttpConnector.GetDataRequest("SumHousehold", new Dictionary<String, String>()
            {
                {"GID",UserSession.Id},
                {"CD","010"},
                {"TP","011"}
            })) - Decimal.Parse(HttpConnector.GetDataRequest("SumHousehold", new Dictionary<String, String>()
            {
                {"GID",UserSession.Id},
                {"CD","010"},
                {"TP","012"}
