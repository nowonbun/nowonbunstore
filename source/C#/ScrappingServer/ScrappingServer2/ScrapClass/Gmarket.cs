...
{
    public class Gmarket : AbstractClass, ICommonScrap
    {
        public Gmarket(string id, string pw, string[] args)
            : base(id, pw, args)
        {
        ...
        protected override void Execute(IScrapping scrap)
        {
            try
            {
                // http://localhost:10000/?type=scrap_request&code=001&apply=2&id=wogjsl0213&pw=dhwogjs02!
        ...
        protected override void Finish()
        {
            ...
            try
            {
                List<long> IndexList = FactoryDao.GetScrappingDataDao().GetIndex(PARAM[0], "001");
            ...
            FactoryDao.GetScrappingTotalDataDao().Delete(PARAM[0], "001");
            scraptotal.ApplyNum = Convert.ToInt64(PARAM[0]);
            scraptotal.Id = ID;
            scraptotal.SiteCode = "001";
